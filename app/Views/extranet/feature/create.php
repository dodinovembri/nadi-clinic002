            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="<?= base_url('extranet/feature/store') ?>" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            ...
                                            <a href="<?= base_url('extranet/feature') ?>"><button type="button" class="btn btn-warning">Cancel</button></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
