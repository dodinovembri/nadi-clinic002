                                        ...
                                        <tbody>
                                            ...
                                            foreach ($clients as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="text-success mr-2" href="<?= base_url('extranet/client/show/' . $value->id) ?>">
                                                            <i class="nav-icon i-Eye font-weight-bold"></i>
                                                        </a>
                                                        <a class="text-success mr-2" href="#">
                                                            <i class="nav-icon i-Pen-2 font-weight-bold" data-toggle="modal" data-target="#editModal<?= $value->id ?>"></i>
                                                        </a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="<?= base_url('extranet/client/destroy/' . $value->id) ?>"><button class="btn btn-primary ml-2" type="button">Delete</button></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal fade" id="editModal<?= $value->id ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <form action="<?= base_url('extranet/client/update/' . $value->id) ?>" method="post">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
