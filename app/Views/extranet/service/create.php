            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="<?= base_url('extranet/service/store') ?>" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <sub>.jpg or .png file, size: <span style="color:red"><b>512x512</b></span> pixels</sub>
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Status</label>
                                        ...
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            ...
                                            <a href="<?= base_url('extranet/service') ?>"><button type="button" class="btn btn-warning">Cancel</button></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
