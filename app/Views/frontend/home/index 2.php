                ...
                <div class="container">
                    <div class="row medical-schedules">
                        <div class="col-xl-3 box-one bg-color-primary appear-animation" data-appear-animation="fadeInLeft" data-appear-animation-delay="0">
                            <div class="feature-box feature-box-style-2 align-items-center p-4">
                                <div class="feature-box-icon p-0">
                                    <img src="<?= base_url('assets/images/icon/medical-icon-heart.png') ?>" alt class="img-fluid pt-1" />
                                </div>
                        ...
                        <div class="col-xl-3 box-two bg-color-tertiary appear-animation" data-appear-animation="fadeInLeft" data-appear-animation-delay="600">
                            <h5 class="m-0">
                                <a href="<?= base_url('doctor') ?>" data-toggle="modal" data-target="#largeModaldokter">
                                    Poli Anak & Kandungan
        ...
        <section id="biaya" class="section">
            <div class="container">
                ...
                <div class="row">
                        <div class="col">
                            ...
                            <div class="appear-animation popup-gallery-ajax animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" style="animation-delay: 200ms;">
                                ...
                                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-286px, 0px, 0px); transition: all 0s ease 0s; width: 3435px;">
                ...
                <div class="process process-vertical">
                    <?php // $no = 0; $delay = 0; foreach ($notes_biaya as $key => $value) { $no++; $delay = $delay + 200; ?>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row process">
                                <?php // $delay = 0; $no = 0; foreach ($notes_kamar as $key => $value) { $delay = $delay + 200; $no++; ?>
            ...
            <div class="row mt-5 mb-5 pt-1">
                <div class="col-lg-4">
                    ...
                    <div class="owl-stage-outer">
                        <div class="owl-stage" style="transform: translate3d(-1080px, 0px, 0px); transition: all 0s ease 0s; width: 2160px;">  <div class="owl-item cloned" style="width: 350px; margin-right: 10px;">
                                <div>
